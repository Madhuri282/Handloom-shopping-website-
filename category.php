...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"> <!--<i class="icon fa fa-desktop fa-fw"></i>  <img src="threads.png" alt=""> <i class="fa-solid fa-heart"></i>-->
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/cat-banner-1.jpg" alt="" class="img-responsive" height=100px>
			</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md">
						<?php $ban = htmlentities($row['categoryName']);
						echo '<p style="font-weight:bold;color:white;margin-left:140px; font-size:70px;font-family:serif; margin-top:-100px;">'.$ban.'</p>';
						?>
					</div>
			<?php } ?>
