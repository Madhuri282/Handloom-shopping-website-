...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md">
						...
						<?php $ban = htmlentities($row['subcategory']);
						echo '<p style="font-weight:bold;color:white;margin-left:10px; font-size:60px;font-family:serif; margin-top:-100px;">'.$ban.'</p>';
						?>
					</div>
			<?php } ?>
